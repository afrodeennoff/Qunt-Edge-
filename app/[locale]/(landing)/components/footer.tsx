...
export default function Footer() {
  ...
  const navigation = {
    ...
    social: [
      { name: 'GitHub', href: 'https://github.com/hugodemenez/quntedge', icon: (props: React.SVGProps<SVGSVGElement>) => (
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <div className="flex items-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">QuntEdge</h3>
            </div>
